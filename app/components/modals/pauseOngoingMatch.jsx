...
export default function PauseMatch({ visible, resumeMatch, onBackToMenu }) {
    const content = (
        <View style={styles.overlay}>
            <View style={styles.buttonsWrap}>
                ...
                >
                    <TouchableOpacity style={styles.buttonTapArea} onPress={() => resumeMatch()} activeOpacity={0.9}>
                ...
                <View style={[styles.buttonGradient, styles.invertedButton]}>
                    <TouchableOpacity
                        ...
                        activeOpacity={0.9}
                    >
                        <Text style={styles.invertedButtonText}>Exit to Menu</Text>
                    </TouchableOpacity>
                </View>
            </View>
        </View>
